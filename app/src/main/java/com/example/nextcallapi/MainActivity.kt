...
import com.example.nextcallapi.ui.theme.NextCallApiTheme
...
import com.example.nextcallapi.db.ProductDatabase
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            NextCallApiTheme(dynamicColor = false) {
                ...
                Scaffold(bottomBar = {
                    ...
                    NavHost(
                        ...
                        composable(route = "favourite_list_screen") {
                            FavouriteListScreen(productViewModel, context, innerPadding)
                        }
...
fun BottomBarItems(navController: NavController){
    Row(modifier = Modifier.fillMaxSize().padding(start = 30.dp, end = 30.dp),
        ...
        IconButton(
            ...
            Icon(
                ...
                contentDescription = "lista producto"
            )
        }
        IconButton(
